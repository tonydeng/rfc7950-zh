...
| `contact`   | [7.1.8](7.1.md#)| 0..1|
| `container` | [7.5](7.5.md)   | 0..n|
| `description`| [7.21.3](7.21.md#)| 0..1|
| `deviation` | [7.20.3](7.20.md#) | 0..n|
| `extension` | [7.19](7.19.md)    | 0..n|
| `feature`   | [7.21.1](7.21.md#) | 0..n|
| `grouping`  | [7.12](7.12.md)    | 0..n|
| `identity`  | [7.18](7.18.md)    | 0..n|
| `import`    | [7.1.5](7.1.md#715-import声明)| 0..n|
| `include`   | [7.1.6](7.1.md#)| 0..n|
| `leaf`      | [7.6](7.6.md)| 0..n|
| `leaf-list` | [7.7](7.7.md)| 0..n|
| `list`      | [7.8](7.8.md)| 0..n|
| `namespace` | [7.1.3](7.1.md#713-namespace声明)| 1|
| `notification`| [7.16](7.16.md)| 0..n|
| `organization`| [7.1.7](7.1.md#)| 0..1|
| `prefix`    | [7.1.4](7.1.md#)| 1|
| `reference` | [7.21.4](7.21.md#)| 0..1|
| `revision`  | [7.1.9](7.1.md#)| 0..n|
