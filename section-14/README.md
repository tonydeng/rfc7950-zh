...
在`YANG`中，几乎所有的陈述都是无序的。 `ABNF`语法[[RFC5234](https://tools.ietf.org/html/rfc5234)] [[RFC7405](https://tools.ietf.org/html/rfc7405)]定义了规范的顺序。 为了提高模块可读性，建议按此顺序输入条款。
...
submodule-stmt      = optsep submodule-keyword sep identifier-arg-str optsep
                      "{" stmtsep
